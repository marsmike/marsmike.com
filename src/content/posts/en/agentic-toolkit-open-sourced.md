...
What's there right now is a skeleton: a marketplace manifest, a license (MIT), a contributor agreement (DCO sign-off), and a roadmap that says "next plugin lands shortly." There are around twenty plugins on the private side right now. They've been built and battle-tested across actual daily work, research, knowledge management, deck production, video pipelines, homelab control, social amplification. They'll arrive here one by one, each as its own teaching artifact, each in the shape it deserves.
