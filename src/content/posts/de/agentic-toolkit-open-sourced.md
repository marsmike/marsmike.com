...
Was heute öffentlich ist, ist der erste echte Ausschnitt und kein bloßes Teaser-Gerüst mehr: Marketplace-Manifest, MIT, DCO-Sign-off, CI, Contributor-Scaffolding und mit Feinschliff ein vollständig dokumentiertes erstes Plugin. In diesem einen Plugin steckt die Release-Logik bereits im Kleinen: v2-Template-Architektur, 34 gebackene PowerPoint-Templates pro Marke, 11 offen lizenzierte Brand-Packs und auf dem aktuellen Branch ein Slide-Pattern-Atlas, der die Planung an konkreten Beispielen erdet. Auf der privaten Seite existieren weiterhin einundzwanzig Plugins. Sie sind im Alltag entstanden und im Alltag erprobt – Recherche, Wissensmanagement, Deck-Produktion, Video-Pipelines, Homelab-Steuerung, Social Amplification. Sie kommen einzeln hier an, jedes als eigenes Lehrartefakt, jedes in der Form, die es verdient.
